        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <div className="relative" ref={dropdownRef}>
              <button
                className="relative  cursor-pointer flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-br from-gray-700 to-gray-800 border border-gray-600 hover:border-gray-500"
                onClick={() => setOpen(!open)}
              >
                {progress?.streak > 0 && (
                  <span className="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full px-1 flex items-center">
